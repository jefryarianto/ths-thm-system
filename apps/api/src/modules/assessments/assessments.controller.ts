...
export class AssessmentsController {
  ...
  @Get('aspects') getAspects(@Query() q: AssessmentFilterDto) { return this.service.getAspects(q); }
  @Get('aspects/:id') getAspect(@Param('id') id: string) { return this.service.getAspect(id); }
  @Post('aspects') createAspect(@Body() dto: CreateAspectDto) { return this.service.createAspect(dto); }
  ...
  @Post('scores') createScore(@Body() dto: CreateScoreDto) { return this.service.createScore(dto); }
