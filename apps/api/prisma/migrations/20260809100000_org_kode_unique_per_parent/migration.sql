...
CREATE UNIQUE INDEX "wilayah_distrik_id_kode_wilayah_key" ON "wilayah"("distrik_id", "kode_wilayah");
CREATE UNIQUE INDEX "ranting_wilayah_id_kode_ranting_key" ON "ranting"("wilayah_id", "kode_ranting");
