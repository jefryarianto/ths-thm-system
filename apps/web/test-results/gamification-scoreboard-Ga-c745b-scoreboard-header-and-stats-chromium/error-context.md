...
- Name: gamification-scoreboard.spec.ts >> Gamification Scoreboard Page >> should display scoreboard header and stats
- Location: e2e\gamification-scoreboard.spec.ts:9:7
...
Locator: locator('h1')
Expected substring: "Scoreboard Gamifikasi"
Received string:    "404"
Timeout: 5000ms
