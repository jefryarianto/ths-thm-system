...
- Name: gamification-scoreboard.spec.ts >> Gamification Scoreboard Page >> should show module comparison cards
- Location: e2e\gamification-scoreboard.spec.ts:80:7
...
Call log:
  - waiting for locator('text=Latihan') to be visible
