...
- Name: registration-flow.spec.ts >> Public Registration Flow >> can fill registration form
- Location: e2e\registration-flow.spec.ts:17:7
...
Call log:
  - waiting for locator('input[placeholder="Masukkan nama lengkap"]')
