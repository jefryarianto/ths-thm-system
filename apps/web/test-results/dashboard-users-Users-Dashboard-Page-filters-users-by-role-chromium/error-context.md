...
- Name: dashboard-users.spec.ts >> Users Dashboard Page >> filters users by role
- Location: e2e\dashboard-users.spec.ts:64:7
...
Call log:
  - waiting for locator('select:first-of-type')
