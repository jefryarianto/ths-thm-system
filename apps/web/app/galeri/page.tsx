    ...
    <PublicLayout>
      ...
      <div className="bg-gradient-to-r from-navy-700 to-navy-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-white font-serif">{t.galeri.title}</h1>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          {data.length > 0 ? (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {data.map((item) => (
                <div key={item.id} className="group relative bg-navy-50 rounded-xl overflow-hidden border border-gray-100 hover:shadow-lg transition-all aspect-[4/3]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-navy-900/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity p-5 flex flex-col justify-end">
