        ...
        <div key={group.category} className="mb-6 last:mb-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {group.items.map((tpl) => (
              <div
                key={tpl.name}
                className="flex items-start gap-3 p-3 rounded-lg border border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 transition cursor-default"
              >
