    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
            Belum ada alamat email yang disupresi
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {suppressions.map((s) => (
                  <tr
                    key={s.id}
                    className="border-b border-gray-100 dark:border-gray-800 hover:bg-red-50/30 dark:hover:bg-red-950/20 transition"
                  >
      ...
      <div className="px-5 py-4 bg-yellow-50 dark:bg-yellow-950/50 border-t border-yellow-200 dark:border-yellow-800 flex items-start gap-2">
        ...
        <p className="text-xs text-yellow-700 dark:text-yellow-400">
          Alamat email otomatis masuk daftar supresi saat terjadi <strong>bounce</strong> atau{' '}
          <strong>complaint</strong>. Klik <strong>Pulihkan</strong> untuk mengizinkan pengiriman
          kembali.
        </p>
      </div>
      ...
      {showAddModal && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl p-6 w-full max-w-md mx-4"
            onClick={(e) => e.stopPropagation()}
          >
            <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">
              Tambah Supresi Manual
            </h3>
