    ...
    items: [
      {
        ...
        trigger: 'Anggota baru dibuat (manual/CSV)',
        label: 'Welcome Anggota',
      },
      {
        name: 'approvedMemberEmail',
        params: '(nama, email, password, nomorAnggota)',
        trigger: 'Calon anggota disetujui jadi anggota',
        label: 'Calon Disetujui',
      },
      {
        name: 'candidateRejectedEmail',
        params: '(nama, alasan)',
        trigger: 'Calon anggota ditolak',
        label: 'Calon Ditolak',
      },
      {
        name: 'registrationApprovedEmail',
        params: '(nama, email, password)',
        trigger: 'Pendaftaran disetujui',
        label: 'Registrasi Disetujui',
      },
      {
        name: 'registrationRejectedEmail',
        params: '(nama, alasan)',
        trigger: 'Pendaftaran ditolak',
    ...
    items: [
      {
        ...
        params: '(nama, kegiatanNama, tanggal, lokasi)',
        trigger: 'Peserta ditambahkan ke kegiatan',
        label: 'Undangan Kegiatan',
      },
      {
        name: 'trainingNotificationEmail',
        params: '(nama, materi, tanggal, waktu)',
        trigger: 'Jadwal latihan baru dibuat',
        label: 'Notif Latihan',
      },
      {
        name: 'attendanceConfirmationEmail',
        params: '(nama, materi, tanggal, statusHadir)',
        trigger: 'Absensi latihan dicatat',
    ...
    items: [
      {
        ...
        params: '(nama, jumlah, bulan, tahun, status)',
        trigger: 'Iuran dibuat/status diupdate lunas',
    ...
    items: [
      {
        ...
        params: '(nama, judulDokumen)',
        trigger: 'Dokumen selesai digenerate',
        label: 'Dokumen Siap',
      },
      {
        name: 'claimStatusEmail',
        params: '(nama, status, alasan?)',
        trigger: 'Status klaim berubah (approve/reject/process)',
        label: 'Status Klaim',
      },
    ],
  },
    ...
    items: [
      {
        ...
        params: '(nama, namaPendadaran, tanggal)',
        trigger: 'Peserta daftar pendadaran',
        label: 'Daftar Pendadaran',
      },
      {
        name: 'graduationResultEmail',
        params: '(nama, lulus, skor?)',
        trigger: 'Hasil pendadaran (lulus/gagal)',
    ...
    items: [
      {
        ...
        params: '(nama, email, password)',
        trigger: 'Penguji baru dibuat',
        label: 'Welcome Penguji',
      },
      {
        name: 'examinerAssignmentEmail',
        params: '(nama, kegiatanNama, tanggal, peran)',
        trigger: 'Penguji ditugaskan ke kegiatan',
        label: 'Penugasan Penguji',
      },
      {
        name: 'userWelcomeEmail',
        params: '(nama, email, role, password)',
        trigger: 'Admin baru dibuat',
        label: 'Welcome Admin',
      },
    ],
  },
    ...
    items: [
      {
        ...
        params: '(namaPenerima, pengirim, perihalSurat, isiDisposisi)',
        trigger: 'Disposisi surat masuk',
        label: 'Disposisi Surat',
      },
      {
        name: 'orgDocumentNotificationEmail',
        params: '(nama, judulDokumen, kategori)',
        trigger: 'Dokumen organisasi baru diupload',
    ...
    items: [
      {
        ...
        params: '(nama, resetLink)',
        trigger: 'User minta reset password',
        label: 'Reset Password',
      },
      {
        name: 'generalNotificationEmail',
        params: '(nama, judul, isi)',
        trigger: 'Notifikasi manual dikirim via admin',
        label: 'Notifikasi Umum',
      },
      {
        name: 'badgeEarnedEmail',
        params: '(nama, badgeName, badgeIcon, description)',
        trigger: 'Anggota mendapat badge baru',
        label: 'Badge Baru',
      },
      {
        name: 'levelUpEmail',
        params: '(nama, oldLevel, newLevel, points)',
        trigger: 'Anggota naik level',
        label: 'Level Up',
      },
    ],
  },
