...
export default function GamificationProfilePage() {
  ...
  return (
      <PermissionGuard module="gamification" action="view">
        <Breadcrumbs suffix={{ href: '#', label: profile?.namaLengkap || 'Detail' }} />
        <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">{profile.namaLengkap || anggotaId}</h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Streak Latihan</span>
                    <Flame size={20} className="text-blue-500" />
                  </div>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{profile.streaks.latihan}</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">latihan berturut-turut</p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Streak Iuran</span>
                    <Star size={20} className="text-green-500" />
                  </div>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{profile.streaks.iuran}</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">iuran tepat waktu</p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Badge Diraih</span>
                    <Award size={20} className="text-purple-500" />
                  </div>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{profile.badges.length}</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">dari 10 badge tersedia</p>
                </div>
              </div>
              ...
              {pointsHistory.length > 1 && (
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Perkembangan Poin</h2>
                  </div>
              ...
              {profile.badges.length > 0 && (
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                  <div className="mb-4">
                    <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Badge Diraih</h2>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
                    {profile.badges.map((badge) => (
                      <div
                        key={badge.id}
                        className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 text-center group hover:shadow-md transition-all"
                      >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Aktivitas Terbaru</h2>
                  <span className="text-xs text-gray-400 dark:text-gray-500">({events.length} event)</span>
                </div>
                {events.length > 0 ? (
                  <div className="space-y-0">
                    {events.map((event, idx) => (
                      <div key={event.id} className="flex gap-4 relative">
                        ...
                        {/* Icon */}
                        <div className="relative z-10 flex-shrink-0 w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                        ...
                        <div className="flex-1 pb-5">
                          ...
                          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{getTimeAgo(event.timestamp)}</p>
                        </div>
                      </div>
                    ))}
                  </div>
