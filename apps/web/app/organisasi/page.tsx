    ...
    <PublicLayout>
      ...
      <div className="bg-gradient-to-r from-navy-700 to-navy-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-white font-serif">{t.organisasi.title}</h1>
              ...
              {data.struktur.map((item, idx) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-gold-50 flex items-center justify-center shrink-0 group-hover:bg-navy-800 transition-colors">
                      <Building2 size={18} className="text-gold-400 group-hover:text-white transition-colors" />
                    </div>
                    <div>
                      <h3 className="text-lg font-bold text-navy-800 mb-1">{item.jabatan}</h3>
