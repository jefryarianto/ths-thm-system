                ...
                <div className="space-y-6">
                    ...
                    >
                      ...
                      <div className="p-6">
                        <div className="flex items-center gap-3 text-xs text-gray-400 mb-3">
                          ...
                          <span className="bg-primary-50 text-primary-500 px-2 py-0.5 rounded-full font-semibold">
                            Headline
                          </span>
                        </div>
                        <h2 className="text-2xl font-bold text-gray-900 group-hover:text-primary-500 transition-colors mb-3">
                          {data[0].judul}
                        </h2>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    {data.slice(1).map((berita) => (
                      ...
                      >
                        <div className="bg-primary-50 h-40 flex items-center justify-center">
                        ...
                        <div className="p-5">
                          ...
                          <div className="mt-3 text-sm text-primary-500 font-semibold flex items-center gap-1">
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-200 focus:border-primary-400 outline-none"
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <div className="space-y-4">
                  {data.slice(0, 5).map((berita) => (
                    ...
                    >
                      <h4 className="text-sm font-semibold text-gray-800 group-hover:text-primary-500 transition-colors line-clamp-2">
                        {berita.judul}
                      </h4>
