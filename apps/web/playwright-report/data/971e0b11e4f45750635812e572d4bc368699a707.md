...
- Name: gamification-scoreboard.spec.ts >> Gamification Scoreboard Page >> should show module breakdown chart with real data
- Location: e2e\gamification-scoreboard.spec.ts:23:7
...
Call log:
  - waiting for locator('.recharts-responsive-container') to be visible
