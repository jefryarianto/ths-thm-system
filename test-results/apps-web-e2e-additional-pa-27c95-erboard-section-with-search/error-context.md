...
- Name: apps\web\e2e\additional-pages.spec.ts >> Additional Dashboard Pages >> Gamification Main Page >> renders leaderboard section with search
- Location: apps\web\e2e\additional-pages.spec.ts:90:9
...
Call log:
  - navigating to "/gamification", waiting until "load"
