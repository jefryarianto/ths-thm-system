...
- Name: apps\web\e2e\additional-pages.spec.ts >> Additional Dashboard Pages >> Gamification Main Page >> renders recent activity section
- Location: apps\web\e2e\additional-pages.spec.ts:100:9
