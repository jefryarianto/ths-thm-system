...
- Name: apps\web\e2e\additional-pages.spec.ts >> Additional Dashboard Pages >> Gamification Main Page >> renders header and stat cards
- Location: apps\web\e2e\additional-pages.spec.ts:83:9
