...
- Name: apps\web\e2e\additional-pages.spec.ts >> Additional Dashboard Pages >> Scan Stats Page >> renders absensi table with data
- Location: apps\web\e2e\additional-pages.spec.ts:23:9
