...
- Name: apps\web\e2e\additional-pages.spec.ts >> Additional Dashboard Pages >> Scan Stats Page >> renders stat cards with mock data
- Location: apps\web\e2e\additional-pages.spec.ts:12:9
...
Call log:
  - navigating to "/scan-stats", waiting until "load"
